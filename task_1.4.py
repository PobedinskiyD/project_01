...
# sneakers_code = titles['Кроссовки тип 3 (Adidas)']
# sneakers_item = store[lamp_code][0]
# sneakers_quantity = lamps_item['quantity']
# sneakers_price = lamps_item['price']
# sneakers_cost = lamps_quantity * lamps_price
